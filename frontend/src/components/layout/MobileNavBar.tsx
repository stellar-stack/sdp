          ...
          >
            {({ isActive }) => (
              <>
                ...
                {count > 0 && (
                  <span className="absolute top-0.5 right-0.5 flex h-4 min-w-4 items-center justify-center rounded-full bg-accent px-0.5 text-[10px] font-bold" style={{ color: '#0e0e0e' }}>
                    {count > 9 ? '9+' : count}
                  </span>
                )}
              </>
